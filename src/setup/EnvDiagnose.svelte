...
<style>
  ...
  .kicker { color: var(--good, #2f8f5b); font: 800 .68rem/1.2 var(--font-body); letter-spacing: .08em; text-transform: uppercase; }
  h3 { margin: .35rem 0 .2rem; font: 800 clamp(1.3rem, 4vw, 1.8rem)/1.15 var(--font-display); }
  .intro p { margin: 0; color: var(--ink-soft, #67645c); font: 500 .86rem/1.5 var(--font-body); }
  ...
  legend { padding: 0 .3rem; font: 750 .82rem/1.35 var(--font-body); }
  ...
  label { display: inline-flex; align-items: center; gap: .3rem; padding: .32rem .48rem; border: 1px solid transparent; border-radius: 999px; background: var(--panel-2, #f6f5ef); cursor: pointer; color: var(--ink-soft, #67645c); font: 600 .7rem/1.2 var(--font-body); }
  ...
  .progress { margin: 1rem 0 0; color: var(--ink-soft, #67645c); text-align: right; font: 650 .72rem/1 var(--font-body); }
  ...
  .grade strong { display: grid; place-items: center; width: 4rem; height: 4rem; border: 2px solid currentColor; border-radius: 50%; color: var(--warn, #c98a1e); font: 900 2.2rem/1 var(--font-body); transform: rotate(-5deg); }
  .grade.grade-a strong { color: var(--good, #2f8f5b); }
  .grade span { font: 800 1rem/1.3 var(--font-body); }
  h4 { margin: 1.2rem 0 .5rem; font: 800 .85rem/1.2 var(--font-body); }
  ...
  .fixes p, .clean { margin: 0; font: 650 .78rem/1.4 var(--font-body); }
