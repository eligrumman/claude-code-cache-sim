...
<style>
  ...
  button { flex: 0 0 auto; align-self: stretch; border: 0; border-left: 1px solid var(--line, #d9d6ca); padding: .45rem .65rem; background: var(--panel, #fffef9); color: inherit; cursor: pointer; font: 700 .7rem/1 system-ui, sans-serif; }
  button:hover, button:focus-visible { background: #fff2b8; }
  small { display: block; margin-top: .35rem; color: var(--ink-soft, #67645c); font: 500 .68rem/1.4 system-ui, sans-serif; }
