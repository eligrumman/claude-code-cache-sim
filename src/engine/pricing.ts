// pricing.ts - the ONE source of truth for cache economics.
...
import type { Model, PriceRow } from "./types.js";
...
export const RATE = { input: 1, read: 0.1, w5m: 1.25, w1h: 2, out: 5 } as const;
...
export function priceTable(model: Model): PriceRow {
...
export function tokCost(tok: number, rateTier: number, model: Model): number {
...
export function perTokUSD(model: Model): number {
