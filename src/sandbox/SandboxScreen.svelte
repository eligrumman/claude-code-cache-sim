...
<main class="sandbox">
  ...
  <section class="playground">
    <nav>
      ...
      <div><span class="eyebrow toy-eyebrow">🧪 COST SANDBOX</span><h1 class="toy-title">Conversation playground</h1></div>
